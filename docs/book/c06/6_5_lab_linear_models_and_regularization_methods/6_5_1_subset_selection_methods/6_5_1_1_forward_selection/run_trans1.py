...
try:
    with open(r'd:\site\jinydev\Statistical\src\book\c06\6_5_lab_linear_models_and_regularization_methods\6_5_1_subset_selection_methods\6_5_1_1_forward_selection\trans1.md', 'w', encoding='utf-8') as f:
        f.write(content)
