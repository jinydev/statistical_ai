...
> 11Technically \beta_0 is half the sum of the average debt for house owners and the average debt for non-house owners. Hence, \beta_0 is exactly equal to the overall average only if the two groups have an equal number of members. 
