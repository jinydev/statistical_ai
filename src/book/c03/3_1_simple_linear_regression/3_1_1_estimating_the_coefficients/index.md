...
[< 3.1 Simple Linear Regression](../index.html) | [3.1.2 Assessing the Accuracy of the Coefficient Estimates >](../3_1_2_assessing_the_accuracy_of_the_coefficient_estimates/index.html)
...
0 50 100 150 200 250 300<br>TV<br>25<br>20<br>Sales 15<br>10<br>5<br>
...
Figure 3.1 displays the simple linear regression fit to the `Advertising` data, where $\hat{\beta}_0 = 7.03$ and $\hat{\beta}_1 = 0.0475$. In other words, according to this approximation, an additional $\$1,000$ spent on TV advertising is associated with selling approximately 47.5 additional units of the product.
...
This is the document for 3.1.1 Estimating the Coefficients.  
