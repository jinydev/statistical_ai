...
**FIGURE 3.1.** `Advertising` _데이터에 대한,_ `TV` _상에 매개된_ `sales` _의 선형 회귀 최소 제곱 적합선이 표시되어 있습니다. 이 적합선은 잔차 제곱합을 최소화함으로써 얻어집니다. 각각의 회색 선분은 잔차를 나타냅니다. 이 도면의 경우 플롯의 왼쪽 추세를 다소 과대 예측하기는 하지만 선형 적합선이 변수 관계의 본질을 잘 포착하고 있습니다._
