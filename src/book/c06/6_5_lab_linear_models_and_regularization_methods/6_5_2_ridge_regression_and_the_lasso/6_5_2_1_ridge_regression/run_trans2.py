...
try:
    with open(r'd:\site\jinydev\Statistical\src\book\c06\6_5_lab_linear_models_and_regularization_methods\6_5_2_ridge_regression_and_the_lasso\6_5_2_1_ridge_regression\trans2.md', 'w', encoding='utf-8') as f:
        f.write(content)
