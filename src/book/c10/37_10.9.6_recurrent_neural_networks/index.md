...
# _10.9.6 Recurrent Neural Networks_ 
...
```
In [86]:classLSTMModel(nn.Module):
...
```
In [101]:classNYSEModel(nn.Module):
def__init__(self):
...
```
In [105]:foridx,(x,y)inenumerate(nyse_dm.train_dataloader()):
out=nyse_model(x)
...
```
In [110]:classNonLinearARModel(nn.Module):
def__init__(self):
