...
# _10.9.3 Convolutional Neural Networks_ 
...
```
In [51]:foridx,(X_,Y_)inenumerate(cifar_dm.train_dataloader()):
print('X:',X_.shape)
print('Y:',Y_.shape)
ifidx>=1:
break
...
```
In [53]:classBuildingBlock(nn.Module):
def__init__(self,
in_channels ,
out_channels):
...
```
In [54]:classCIFARModel(nn.Module):
def__init__(self):
